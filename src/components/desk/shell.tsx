...
import { Anchor, BookOpen, LayoutGrid, Radio } from "lucide-react";
        ...
        <div className="mx-auto flex max-w-7xl min-w-0 items-center gap-3 px-4 py-3 sm:px-6">
          <Link to="/" className="flex min-w-0 flex-1 items-center gap-2.5 sm:flex-none">
            ...
            <span className="min-w-0">
              <span className="block truncate font-display text-lg leading-tight tracking-wide text-fg">
                PICKS BOAT BOYZ
              </span>
            ...
            <div className="rounded-md bg-surface px-3 py-2 shadow-border">
              ...
              <p
                className={cn(
                  ...
                  record.units > 0 ? "text-win" : record.units < 0 ? "text-loss" : "text-fg",
                )}
              >
